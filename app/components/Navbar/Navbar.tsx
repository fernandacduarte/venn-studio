  ...
  return (
    <nav className="h-[90px] text-xl mb-1 py-6 px-16 max-lg-sticky top-0 flex gap-8 justify-between items-center ">
      <div className="flex gap-4 items-center">
        <Image
          src={'images/venn-logo.svg'}
          alt="Logo"
          width={36}
          height={36}
          priority
        />
        <span className="font-[family-name:var(--font-montserrat)] font-semibold tracking-[0.02em] text-[1.5rem]">VENN <span className="ml-[2px]">STUDIO</span></span>
      </div>
