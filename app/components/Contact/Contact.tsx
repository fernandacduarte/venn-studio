...
const Contact = () => {
  return (
    ...
    <SimpleCard backgroundColor="rgba(255, 255, 255, 0.2)">
      <Link className={`${styles.parent} max-[639px]:w-full`} href="/contact">
        <div className="h-full flex flex-col justify-between items-center font-medium">
          <div className="w-full flex flex-col items-start">
            <div className="w-full flex justify-between items-center mt-[-12px]">
              ...
              <div className="mr-[-18px] text-[2.5rem] sm:text-[3rem] md:text-[3rem] lg:text-[4rem] rotate-45">
                <IconArrowUpRight size={'1em'} strokeWidth={1.2} />
              </div>
            </div>
            <div className="flex gap-2 items-center sm:absolute lg:static left-5 top-[4.3rem] max-lg:left-8">
              <AvailableNowIcon/>
