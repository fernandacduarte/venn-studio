...
const Projects = () => {
  return (
    ...
    <SimpleCard backgroundColor="hsl(77, 76%, 74%)"> 
      <Link href="/projects" className="max-[639px]:w-full">
        <div className="h-full flex flex-col justify-start gap-4 min-[460px]:justify-between text-neutralDark max-[639px]:w-full">
          <div className="flex justify-between items-start">
            ...
            <div className="font-medium flex flex-col gap-3">
              ...
              <span className="text-[1.3rem] min-[532px]:text-[1.5rem] min-[740px]:text-[1.7rem] min-[840px]:text-[1.5rem] min-[860px]:text-[1.7rem] lg:text-3xl w-full max-w-[18ch] min-[640px]:max-w-[25ch] min-[840px]:max-w-[18ch] min-[860px]:max-w-[18ch] min-[960px]:max-w-[20ch] lg:max-w-[22ch] pr-4 tracking-[0.03em] leading-[2rem] min-[532px]:leading-[2.3rem] min-[740px]:leading-[2.5rem] min-[840px]:leading-[2rem] lg:leading-[2.7rem]">
                Take a look at our work in progress and latest projects
              </span>
            </div>
            <div className="h-full">
              <div className="rounded-full bg-neutralDark flex justify-center items-center rotate-45 text-[2.5rem] min-[500px]:text-[3rem] md:text-[3.5rem] lg:text-[4rem]">
