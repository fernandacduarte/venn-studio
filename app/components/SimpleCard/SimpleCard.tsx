...
const SimpleCard = ({ children, backgroundColor = '' }: { children: React.ReactNode, backgroundColor?: string }) => {
  return (
    <div 
      className={`z-10 overflow-hidden h-full w-full rounded-3xl p-8 sm:p-10 flex-grow bg-transparent relative hover:scale-[1.03] active:scale-95 transition-transform duration-300 cursor-pointer ${styles['blur-background']}`}
