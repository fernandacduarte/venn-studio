    ...
    <div className="animate-fadeIn w-full flex gap-6 flex-grow items-stretch">
      ...
      <div className="h-full w-full max-w-screen-2xl mx-auto md:px-16 min-[375px]:px-6 px-4 lg:px-fluid-16-64 flex flex-col gap-16 flex-grow text-neutralDark mt-2">
        ...
        <div className="flex flex-col gap-12 items-center mt-6 ">
          <span className="text-4xl text-center max-w-[26ch] text-2xl leading-normal min-[375px]:text-3xl min-[375px]:leading-normal min-[500px]:text-4xl min-[500px]:leading-normal font-semibold">Have a game-changing idea? Skip the big agencies</span>
          <span className="max-w-[53ch] text-center text-xl min-[375px]:text-2xl leading-normal min-[500px]:text-3xl min-[375px]:leading-normal min-[500px]:leading-normal font-light">
